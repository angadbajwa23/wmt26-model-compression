...
# llmcompressor's Python code has no hard torch runtime requirement
uv pip install --extra-index-url https://download.pytorch.org/whl/cu128 "torch==2.8.0"
deactivate
...
hf_repo="${HF_MODEL_REPO:-Angad23/gemma-3-12b-it-awq-int4-wmt26}"
...
echo "  Compress venv  : $compress_venv  (llmcompressor, torch chosen by llmcompressor)"
