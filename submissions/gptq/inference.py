...
class VLLMGptq(VLLMTranslator):
    # llm-compressor saves in compressed-tensors format (not legacy auto-gptq format).
    # vLLM detects this from config.json and routes to the Marlin kernel automatically.
...
def main():
    args = parse_inference_args(
        ...
        description="Run translation using vLLM with GPTQ INT4 (compressed-tensors) quantization",
